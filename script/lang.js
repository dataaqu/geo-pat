...
const indexGeo = document.querySelector('.content-geo');
const indexEng = document.querySelector('.content-eng');
...
if (selectedLanguage === "geo") {
  ...
  indexGeo.style.display = 'block';
  indexEng.style.display ='none';
  ...
  indexGeo.style.display = 'none';
  indexEng.style.display ='block';
}
